#!/usr/bin/env python3
"""
DeblurGAN-v2 Research Web Application
====================================
...
- Research-level evaluation tools
"""
...
app.config['MAX_CONTENT_LENGTH'] = 32 * 1024 * 1024  # 32MB for research
...
class MetricsCalculator:
    ...
    def calculate_blur_level(image):
        ...
        return {
            ...
            'level': level,
            'score': min(100, laplacian_var / 10)  # Normalized score
        }
    ...
    def calculate_edge_density(image):
        ...
        return {
            ...
            'edges_per_region': round(edge_pixels / ((edges.shape[0] // 50) * (edges.shape[1] // 50)), 1)
        }
    ...
    def calculate_frequency_analysis(image):
        ...
        high_freq_ratio = (high_freq_energy / total_energy) * 100
...
class PerformanceMonitor:
    ...
    def get_metrics(self):
        ...
        return {
            ...
            'peak_memory_gb': round(self.peak_memory / (1024**3), 2),
...
def process_image_with_analysis(image_path, output_dir):
    ...
    try:
        ...
        # Run deblurring
        print("🧠 Running DeblurGAN-v2 inference...")
        ...
        analysis = {
            ...
            'performance': {
                **performance,
                ...
                'preprocessing_time_ms': round((performance['processing_time_s'] - inference_time) * 500, 1),
                'postprocessing_time_ms': round((performance['processing_time_s'] - inference_time) * 500, 1)
            },
...
def get_processing_statistics():
    ...
    return {
        ...
        'success_rate': 100.0,  # Since we only store successful processes
...
def batch_upload():
    ...
    try:
        ...
        return jsonify({
            ...
            'results': results[:10]  # Return first 10 for display
        })
...
if __name__ == '__main__':
    ...
    if init_predictor():
        ...
        print(f"📱 Mobile Access:   http://{psutil.net_if_addrs()}")
        print("=" * 45)
